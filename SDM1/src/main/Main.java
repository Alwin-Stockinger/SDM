...
public class Main {
	...
	public static void runTestsForDifferentDims(KMeans k, ClusterGenerator gen, int N) {
		...
		for(int dim = 1; dim <= 5; ++dim) {
			...
			ArrayList<Cluster> clusters2 = k.pointLloyd(clusterAmount, points, size);
			...
			ArrayList<Cluster> clusters3 = k.randomMQ(clusterAmount, points, size);
			...
			ArrayList<Cluster> clusters4 = k.pointMQ(clusterAmount, points, size);
			System.out.println("\n");
		}
	}
}
